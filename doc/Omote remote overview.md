...
* [[#Device Type]] Not visible to normal users except when a new, unknown, devices is added.
* [[#Devices]] Most basic building blocks.
* [[#Action]] Combination of devices to create some defined behavior.
* [[#Grouping]] Combination of Actions and devices which additionally represent a state machine to modify button behavior.
